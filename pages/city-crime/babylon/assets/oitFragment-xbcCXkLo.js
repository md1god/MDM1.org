import{d as e}from"./index-DNVpF50N.js";const t="decalFragmentDeclaration",h=`#ifdef DECAL
...
return result;}`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=D);const z={name:v,shader:D},n="textureRepetitionFunctions",T=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=T);const X={name:n,shader:T},d="depthPrePass",E=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=E);const U={name:d,shader:E},f="oitFragment",C=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=C);const b={name:f,shader:C};export{I as a,M as b,z as c,P as d,U as e,b as f,_ as i,A as l,L as o,F as p,R as s,X as t};
