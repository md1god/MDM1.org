import{d as e,h as f,i as c,am as v,an as s,v as l,j as u,ao as m,ap as U,k as E,l as p,m as V,n as S}from"./index-DNVpF50N.js";import{i as I}from"./instancesDeclaration-CKAhidZa.js";import{h}from"./harmonicsFunctions-DKcWjzXo.js";import{b as N}from"./bumpVertex-X3SsUYPA.js";const n="geometryVertexDeclaration",o="uniform mat4 viewProjection;uniform mat4 view;";e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=o);const _={name:n,shader:o},r="geometryUboDeclaration",t=`#include<sceneUboDeclaration>
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=t);const x={name:r,shader:t},a="geometryVertexShader",d=`precision highp float;
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=d);const P=[f,c,v,s,I,_,l,x,u,h,m,U,E,p,V,S,N];for(const i of P)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const g={name:a,shader:d};export{g as geometryVertexShader};
