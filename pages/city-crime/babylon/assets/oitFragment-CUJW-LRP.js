import{d as e}from"./index-DNVpF50N.js";const r="prePassDeclaration",u=`#ifdef PREPASS
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=h);const P={name:o,shader:h},f="clusteredLightingFunctions",m=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=m);const E={name:f,shader:m},v="shadowsFragmentFunctions",S=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=S);const F={name:v,shader:S},s="imageProcessingDeclaration",x=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=x);const z={name:s,shader:x},i="imageProcessingFunctions",w=`#if TONEMAPPING==3
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=y);const A={name:p,shader:y};export{P as a,I as b,E as c,b as d,A as e,z as i,_ as l,L as o,C as p,F as s,M as t};
