import { b3 as WebGPUEngine, b4 as Engine, ax as Scene, F as FreeCamera, c as Vector3, H as HemisphericLight, i as StandardMaterial, j as Color3, b5 as MeshBuilder } from "./babylon-core-DhADYfIs.js";
import "./babylon-postprocess-V_CCuZLp.js";
async function createPreferredEngine(canvas) {
  try {
...
async function runSceneBenchmark(engine) {
  ...
  return new Promise((resolve) => {
    ...
    const render = (now) => {
      ...
      scene.dispose();
      const tier = averageFps >= 57 ? "Ultra" : averageFps >= 47 ? "High" : averageFps >= 34 ? "Medium" : "Low";
