import{d as e,v as t,w as r,j as n,u as l,n as s}from"./index-DNVpF50N.js";import{g as f,a as c,b as p}from"./gaussianSplatting-DiYdGNGG.js";import{f as d,a as S}from"./fogVertex-C9IYba1D.js";import{l as u}from"./logDepthDeclaration-C-tO61AF.js";import{l as m}from"./logDepthVertex-CRumpIRd.js";const a="gaussianSplattingVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=i);const _=[f,t,r,c,n,d,u,l,p,s,S,m];for(const o of _)e.IncludesShadersStore[o.name]||(e.IncludesShadersStore[o.name]=o.shader);const h={name:a,shader:i};export{h as gaussianSplattingVertexShader};
