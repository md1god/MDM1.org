import{d as e}from"./index-DNVpF50N.js";import"./mainUVVaryingDeclaration-CoPVoT_W.js";import"./oitFragment-CUJW-LRP.js";const t="pbrFragmentExtraDeclaration",g=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=p);const _={name:f,shader:p},r="pbrHelperFunctions",L=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=T);const H={name:s,shader:T},d="pbrBlockNormalGeometric",N=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=N);const y={name:d,shader:N},u="pbrBlockImageProcessing",C=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=C);const W={name:u,shader:C},v="pbrDebug",I=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=I);const z={name:v,shader:I};export{B as a,U as b,b as c,P as d,V as e,H as f,y as g,x as h,_ as i,W as j,z as k,F as p,G as s};
