...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=S);const Ge={name:o,shader:S},t="openpbrFragmentSamplersDeclaration",T=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=T);const xe={name:t,shader:T},r="openpbrNormalMapFragmentMainFunctions",A=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=A);const ye={name:r,shader:A},a="openpbrNormalMapFragmentFunctions",N=`#if defined(GEOMETRY_NORMAL)
...
`;e.ShadersStore[I]||(e.ShadersStore[I]=W);const Je=[Z,$,ae,j,Ge,H,B,_e,de,me,q,K,Ae,be,xe,Q,V,Fe,De,J,k,ue,ge,Ee,ee,ie,Ce,oe,ve,pe,Pe,he,Re,Le,ye,ze,Ne,ne,Ue,Xe,se,ce,we,Y,Ie,We,He,Be,fe,le,Ve,ke,Ye,Ze,te,$e,je,qe,Ke,Me,Oe,Se,Qe,re,Te];for(const i of Je)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const mi={name:I,shader:W};export{mi as openpbrPixelShader};
