import{d as a,v as o,w as r}from"./index-DNVpF50N.js";import{g as n,a as l,b as s}from"./gaussianSplatting-DiYdGNGG.js";const e="gaussianSplattingVoxelVertexShader",i=`#include<__decl__gaussianSplattingVertex>
...
#endif
vPatchPosition=position.xy;}`;a.ShadersStore[e]||(a.ShadersStore[e]=i);const p=[n,o,r,l,s];for(const t of p)a.IncludesShadersStore[t.name]||(a.IncludesShadersStore[t.name]=t.shader);const m={name:e,shader:i};export{m as gaussianSplattingVoxelVertexShader};
