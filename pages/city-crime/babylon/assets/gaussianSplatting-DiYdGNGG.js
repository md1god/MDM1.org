import{d as e}from"./index-DNVpF50N.js";const t="gaussianSplattingVertexDeclaration",o="attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;";e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=o);const n={name:t,shader:o},a="gaussianSplattingUboDeclaration",c=`#include<sceneUboDeclaration>
...
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=c);const x={name:a,shader:c},s="gaussianSplatting",i=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=i);const r={name:s,shader:i};export{x as a,r as b,n as g};
