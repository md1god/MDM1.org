import{d as e}from"./index-DNVpF50N.js";import{p as d}from"./packingFunctions-CiMKs5Az.js";import{c as p,a as c}from"./clipPlaneFragment-LjS3fiel.js";const r="bayerDitherFunctions",f=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
}`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=o);const M=[d,h,u,p,c,l];for(const a of M)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const E={name:i,shader:o};export{E as shadowMapPixelShaderWGSL};
